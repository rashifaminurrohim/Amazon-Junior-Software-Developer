package WritingDifferentFileTypesLab.solution;
import java.io.*;
...
public class Main {
    public static void textFileWrite() {
        ...
        try  {
            FileWriter fileObj = new FileWriter("src/WritingDifferentFileTypes/solution/file1.txt");
    ...
    public static void binaryFileWrite() {
        ...
        try (FileOutputStream fileObj = new FileOutputStream("src/WritingDifferentFileTypes/solution/file2.dat")) {
    ...
    public static void printWrite() {
        String data;
        try {
            PrintWriter fileObj = new PrintWriter("src/WritingDifferentFileTypes/solution/file3.txt");
    ...
    public static void streamWrite() {
        try {
            FileOutputStream file = new FileOutputStream("src/WritingDifferentFileTypes/solution/file4.dat");
